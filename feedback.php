...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    flash_set(
        'success',
        'Your feedback was submitted and routed to the ' . role_label($targetRole) . '.'
    );
...
<main class="main">
  <div class="page">
    ...
    <section class="hero">
      ...
      <p class="hero__lead">
        Choose the issue type, set the routing target, and decide whether your name should remain hidden.
      </p>
    </section>
      ...
      <div class="card">
        ...
        <div class="section__head">
          <div>
            ...
            <p class="section__sub">Stored and routed automatically by backend logic.</p>
          </div>
        ...
        <form method="post" class="form-grid">
          ...
          <div class="field">
            ...
            <div class="field__hint">
              Harassment-related feedback is routed only to Student Affairs.
            </div>
          </div>
      ...
      <div class="card">
        ...
        <div class="section__head">
          <div>
            ...
            <p class="section__sub">Latest feedback activity.</p>
          </div>
        </div>
          ...
          <?php foreach ($myHistory as $item): ?>
            <div class="feedback-item">
              ...
              <div class="row" style="justify-content:space-between;">
                ...
                <span class="<?= h(status_badge_class($item['status'])) ?>">
                  <?= h($item['status']) ?>
                </span>
              </div>
              ...
              <div class="muted" style="margin-top:0.35rem;">
                <?= h(relative_time($item['created_at'])) ?>
              </div>
    ...
    <div class="footer">
      Feedback remains subject to university privacy and ethics rules.
    </div>
